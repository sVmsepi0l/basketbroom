...
def docs(ue):
    contracts={
        ...
        'GeometryScript_MeshEdits':['set_all_mesh_vertex_positions','delete_triangles_from_mesh','append_buffers_to_mesh','append_mesh'],
        'GeometryScript_Materials':['set_all_triangle_material_ids','set_all_triangle_material_i_ds'],
